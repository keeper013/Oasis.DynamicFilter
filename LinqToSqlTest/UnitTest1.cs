...
public class UnitTest1 : TestBase
{
    ...
    {
        var expressionMaker = new FilterBuilder().Register<Entity1, EntityFilter>().Build();
        ...
        await ExecuteWithNewDatabaseContext(async databaseContext =>
        {
            ...
            var filter = new EntityFilter { Number = 2 };
            var exp = expressionMaker.GetExpression<Entity1, EntityFilter>(filter);
